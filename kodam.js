function cekKhodam() {
    ...
    if (!nameInput) {
        Swal.fire({
            title: "HARUS DI ISI NAMA DULU LAEEE!",
            icon: "error",
    ...
    setTimeout(() => {
        const khodams = [
            ...
            { name: "Kambing Keriting", meaning: "Kamu kuat dan penuh dedikasi, selalu menemukan jalan menuju tujuanmu." },
            { name: "Babi Tunggal", meaning: "Kamu adalah orang yang jalan dengan cepat dan tidak terlalu berguna" },
            { name: "Rante Babi", meaning: "Kamu adalah orang yang tidak berguna yang hanya bisa jalan lurus kedepan, dan selalu terikat oleh pacarmu " },
